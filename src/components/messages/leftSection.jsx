...
const LeftSection = () => {
    return (
        <section className='w-[23%] h-screen border-[#e5e5e5] border-r-[1px]'>
            ...
            <div className='px-[15px] py-[15px] overflow-hidden'>
            ...
            <div className='px-[15px] py-[5px] overflow-hidden'>
                ...
                <div className='py-[10px] h-[350px] overflow-y-auto'>
                    <MessageUser />
                    <MessageUser />
                    <MessageUser />
                    <MessageUser />
