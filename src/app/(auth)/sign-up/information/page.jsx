    ...
    return (
        <section className='w-[100%] flex font-poppins' >
            ...
            <div className='w-[50%] px-[80px] flex flex-col justify-center'>
                ...
                <input type='text' placeholder='Full Name' className='focus:outline-0 px-[15px] mt-[15px] bg-[#f5f2f2] w-[500px] h-[45px] rounded-[5px] ' />
                <input type='password' placeholder='Date Of Birth' className='focus:outline-0 px-[15px] mt-[15px] bg-[#f5f2f2] w-[500px] h-[45px] rounded-[5px] ' />
                <input type='password' placeholder='Bio' className='focus:outline-0 px-[15px] mt-[15px] bg-[#f5f2f2] w-[500px] h-[45px] rounded-[5px] ' />
