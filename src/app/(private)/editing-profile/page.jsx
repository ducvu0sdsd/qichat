    ...
    return (
        <section className='overflow-y-auto h-screen pb-[2rem]'>
            <div className='w-full relative flex items-center justify-center'>
                ...
                <div className='flex flex-col absolute left-[14%] bottom-[-25%]'>
            ...
            <div className='w-full px-[12rem] pt-[2rem]'>
                ...
                <div className='mt-[1rem] px-[2rem] grid grid-cols-2'>
                    ...
                    <Input title={'Date Of Birth'} value={data.user?.dateOfBirth} />
                    <Input title={'Phone'} value={data.user?.phone} />
                    <Input title={'Email'} value={data.user?.email} />
